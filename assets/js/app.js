...
const displayLatestNews = (newsData) => {
    ...
    newsData.forEach(newsItem => {
        ...
        // Log author thumbnail URL and existence of author image element
        console.log("Thumbnail URL:", newsAuthorThumbnailURL);
        console.log("Author Image Element:", document.getElementById("authorImage"));
